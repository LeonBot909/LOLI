...
async function dood(url) {
  ...
  let pass_md5 =
    "/pass_md5/" + /\$\.get\('\/pass_md5\/(.*?)',/.exec(get_md5.data)[1];
              ...
              .then((res) => {
                axios.get(res).then((resp) => {
                  ...
                  const result = {
                    ...
                    caption: ch(
                      "#card-page > div > div.row > div > div > div.main_info.mb-4 > div.main_list"
                    ).text(),
                    likes: ch(
                      "#card-page > div > div.row > div > div > div.main__info.mb-4 > div > div:nth-child(1) > span"
                    ).text(),
                    comment: ch(
                      "#card-page > div > div.row > div > div > div.main_info.mb-4 > div.content_btns.d-flex > div:nth-child(2) > span"
                    ).text(),
                    share: ch(
                      "#card-page > div > div.row > div > div > div.main_info.mb-4 > div.content_btns.d-flex > div:nth-child(3) > span"
                    ).text(),
                    video: ch(
                      "#card-page > div > div.row > div > div > div.main_info.mb-4 > div.main_image-container > div > video"
                    ).attr("src"),
                  };
                  resolve(result);
                });
